...
/* _____________________________________
    ...
    function initMap(map) {
      ...
      // centered map point
      var latlng = new google.maps.LatLng(19.272738, 72.878224);

      // points marker info and coordinates
      var points = [
        ['<div class="wrapper"><h4>Shebi Enterprises Office</h4><h5>Opening Hours</h5><p>Mo – Fr: 08:30 – 20:00</p></div>', 19.272738, 72.878224],
        ['<div class="wrapper"><h4>Shebi Enterprises</h4><h5>Opening Hours</h5><p>Mo – Fr: 08:30 – 20:00</p></div>', 19.272738, 72.878224]
      ];
      // marker
